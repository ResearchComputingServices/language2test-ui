...
function UpcomingTests({ data }) {
    ...
    const fetchData = async query => {
        try {
            const { count } = await service.getUpcomingTestsCount();
            const fetchQuery = {
            ...
            const data = await service.getUpcomingTests(fetchQuery);
            return {
                data,
                page: query.page,
                totalCount: count,
...
UpcomingTests.propTypes = { data: PropTypes.array };

UpcomingTests.defaultProps = { data: undefined };
